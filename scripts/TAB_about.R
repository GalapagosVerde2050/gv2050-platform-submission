...
about_tab <- tabItem(tabName = "about",
                     ...
                     fluidRow(
                       ...
                       column(width = 6,
                              div(style="text-align:left",tags$h3("How to use RestoR?")),
                              box(width = "100%", status = "success",
                                  "RestoR was designed to have an intuitive UI that follows the steps of the restoration process. RestoR allows you to:",
                                  tags$ul(
